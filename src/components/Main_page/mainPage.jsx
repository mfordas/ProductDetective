...
const MainPageContent = () => {
    return (
        <div className='mainPage'>
            <p>
                Welcome on my simple page for checking Nutrinion score of products.
                Page is based on <a href='https://world.openfoodfacts.org/' target='_blank'><b>Open Food Facts API</b></a>
            </p>
            <p>
